...
//  Nomad
//
//  Created by Datta Kansal on 10/6/24.
//


import XCTest
import FirebaseFirestore // Assuming Firestore is imported for your app
@testable import Nomad // Replace `YourApp` with the actual app module name
